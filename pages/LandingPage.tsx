        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center md:text-left mt-16">
          <div className="md:w-3/4 lg:w-2/3">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link to="/products" className="bg-white/10 backdrop-blur-md border border-white/30 text-white font-bold py-4 px-10 rounded-full hover:bg-white/20 transition flex items-center justify-center gap-2 text-lg">
